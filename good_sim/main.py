...
def train(net, data_loader, train_optimizer):
    ...
    for pos_1, pos_2, target in train_bar:
        ...
        loss2 = criteria(out_1,out_2)
        losses.set_description('loss1: {:.4f} loss2: {:.4f}'.format(loss.item(), loss2.item()))
...
if __name__ == '__main__':
    ...
    memory_loader = DataLoader(memory_data, batch_size=batch_size, shuffle=False, num_workers=6, pin_memory=True)
